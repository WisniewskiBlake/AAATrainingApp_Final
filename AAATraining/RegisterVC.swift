...
//         }.resume()
        ...
        let body = "email=\(emailTextField.text!.lowercased())&firstName=\(firstNameTextField.text!.lowercased())&lastName=\(lastNameTextField.text!.lowercased())&password=\(passwordTextField.text!)&birthday=\(datePicker.date)&height=\(heightTextField.text!)&weight=\(weightTextField.text!)&position=\(positionTextField.text!.lowercased())&number=\(numberTextField.text!)&ava=\("http://localhost/fb/cover/25/cover.jpg")&cover=\("http://localhost/fb/cover/25/cover.jpg")"
