            ...
            if isVideoSelected {
                ...
                uploadPostVideo(video: videoData!, view: self.navigationController!.view) { (videoLink) in
                    ...
                    if videoLink != nil {
                        ...
                        let nutritionPost = Nutrition(nutritionPostID: self.nutritionPostID, nutritionTeamID: FUser.currentUser()!.userCurrentTeamID, nutritionOwnerID: FUser.currentId(), nutritionText: self.postTextView.text, nutritionPicture: thumbToUpload!, nutritionDate: "", nutritionPostUserAva: FUser.currentUser()!.ava, nutritionPostUserName: fullName, nutritionVideo: videoLink!, nutritionPostType: "video", nutritionPostUrlLink: self.urlLinkTextField.text!)
                ...
                return
                    ...
                    let fullName = FUser.currentUser()!.firstname + " " + FUser.currentUser()!.lastname
                    let nutritionPost = Nutrition(nutritionPostID: self.nutritionPostID, nutritionTeamID: FUser.currentUser()!.userCurrentTeamID, nutritionOwnerID: FUser.currentId(), nutritionText: self.postTextView.text, nutritionPicture: self.pictureToUpload!, nutritionDate: "", nutritionPostUserAva: FUser.currentUser()!.ava, nutritionPostUserName: fullName, nutritionVideo: "", nutritionPostType: "picture", nutritionPostUrlLink: self.urlLinkTextField.text!)
                ...
                let fullName = FUser.currentUser()!.firstname + " " + FUser.currentUser()!.lastname
                let nutritionPost = Nutrition(nutritionPostID: self.nutritionPostID, nutritionTeamID: FUser.currentUser()!.userCurrentTeamID, nutritionOwnerID: FUser.currentId(), nutritionText: self.postTextView.text, nutritionPicture: "", nutritionDate: "", nutritionPostUserAva: FUser.currentUser()!.ava, nutritionPostUserName: fullName, nutritionVideo: "", nutritionPostType: "text", nutritionPostUrlLink: self.urlLinkTextField.text!)
