...
public class FUser {
    ...
    var userTeamNotifications: [String]
    ...
    init(_objectId: String, _pushId: String?, _createdAt: Date, _updatedAt: Date, _email: String, _firstname: String, _lastname: String, _avatar: String = "", _loginMethod: String, _phoneNumber: String, _height: String, _weight: String, _position: String, _number: String, _accountType: String, _birthday: String, _cover: String, _userCurrentTeamID: String, _userTeamColorOne: String, _userTeamColorTwo: String, _userTeamColorThree: String, _userTeamIDs: [String], _userTeamAccountTypes: [String], _userTeamNames: [String], _userTeamMembers: [String], _userTeamNotifications: [String], _userIsNewObserverArray: [String]) {
        ...
        userTeamNotifications = _userTeamNotifications
    ...
    init(_dictionary: NSDictionary) {
        ...
        if let tMC = _dictionary[kUSERTEAMNOTIFICATIONS] {
            userTeamNotifications = tMC as! [String]
        } else {
            userTeamNotifications = []
        }
