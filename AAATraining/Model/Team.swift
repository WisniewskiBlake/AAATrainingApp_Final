...
public class Team {
    //set up FUser to have a team and then set his team default like FUser.team() = "team loaded in after team code is typed"  in register and set FUser.cover to be the same as Team.logo
